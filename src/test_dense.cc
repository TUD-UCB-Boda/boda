...
namespace boda {
        ...
        // bases=["has_main_t"], type_id="test_dense")
    {
        ...
        virtual void main(nesi_init_arg_t *nia) {
            ...
            run_cnet_dense->in_dims["y"] = max_img_sz.d[1];
            run_cnet_dense->in_dims["x"] = max_img_sz.d[0];
        ...
        void
        comp_win(i32_box_t const &feat_box, p_nda_float_t out_batch_dense, p_img_t const &img, u32_pt_t const &nc) {
            ...
            p_nda_float_t out_batch;
            {
                ...
                bool is_fail = 0;
                if ((ssds_diff.mrd >= mrd_toler) || ssds_diff.has_nan()) {
                    ++num_mad_fail;
                    is_fail = 1;
                }
